...
PROJECT_URL = "https://bzopnvxahrigajeuvlqw.supabase.co"              # URL project Supabase kamu
TABLE = "mahasiswa"                                          # nama tabel di database
SUPABASE_URL = f"{PROJECT_URL}/rest/v1/{TABLE}"               # endpoint REST Supabase

API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJ6b3BudnhhaHJpZ2FqZXV2bHF3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAzOTkxNjAsImV4cCI6MjA5NTk3NTE2MH0.GLlkx4jTeUJHEbJ6QGiLuGEVA7J9Q-ib9TAtMv7T08k"                             # gunakan publishable / anon key
